    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
        ...
        >
          ...
          <p className="text-yellow-500 text-[9px] font-semibold uppercase tracking-[0.5em] mb-3">
            Order Confirmed
          </p>
          <h2 className="text-3xl font-semibold text-white mb-4 uppercase tracking-tighter">
            Order Placed
          </h2>
          <p className="text-gray-500 font-medium mb-10 text-xs px-4 uppercase tracking-widest leading-relaxed">
            ...
            <span className="text-yellow-500 font-semibold">#{displayId}</span>{' '}
          ...
          <div className="bg-black/60 rounded-[2rem] p-8 mb-10 border border-yellow-900/10">
            <div className="grid grid-cols-2 gap-6 divide-x divide-white/5">
              <div className="text-left pr-6">
                <span className="text-[9px] font-semibold text-gray-600 uppercase tracking-widest block mb-2">
                  Payment Mode
                </span>
              ...
              <div className="text-right pl-6">
                ...
                <p className="text-3xl font-semibold gold-text tracking-tighter">
                  ₹{displayTotal}
                </p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <button
              ...
              className="w-full bg-white/5 border border-white/10 hover:border-yellow-500/30 text-white font-semibold py-4 rounded-2xl flex items-center justify-center gap-3 uppercase tracking-widest text-[9px] active:scale-95 transition-all"
            >
              <Package size={16} /> My Orders
            </button>
            <button
              onClick={() => handleNavigate('/')}
              className="w-full bg-yellow-500 hover:bg-yellow-400 text-black font-semibold py-4 rounded-2xl flex items-center justify-center gap-3 uppercase tracking-widest text-[9px] shadow-2xl shadow-yellow-500/20 active:scale-95 transition-all"
            >
