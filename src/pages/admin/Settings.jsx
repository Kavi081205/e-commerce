  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4">
        ...
        <p className="text-xs font-semibold uppercase text-gray-500 tracking-widest">Loading settings...</p>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-yellow-900/10 pb-5">
        <div>
          <h1 className="text-2xl font-semibold text-white uppercase tracking-wider">Website Settings</h1>
          <p className="text-[10px] text-yellow-600 font-semibold uppercase tracking-widest mt-1">Configure layout, colors, tags, banners and delivery settings</p>
        </div>
        <div className="flex items-center gap-3">
          <button
            onClick={handleReset}
            className="flex items-center gap-1.5 border border-red-500/20 text-red-400 hover:bg-red-500/5 px-4 py-2.5 rounded-xl text-[10px] font-semibold uppercase tracking-wider transition-all"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          {tabs.map(tab => {
            ...
            return (
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-3.5 rounded-xl text-xs font-semibold uppercase tracking-wider text-left transition-all border ${
                  activeTab === tab.id
        ...
        <form onSubmit={handleSubmit} className="lg:col-span-5 bg-gray-900/40 border border-yellow-900/10 p-6 rounded-3xl space-y-6">
          ...
          {activeTab === 'brand' && (
            <div className="space-y-5">
              <h3 className="text-sm font-semibold text-white uppercase tracking-wider border-b border-white/5 pb-2">Brand Settings</h3>
              
              <div className="flex flex-col gap-1.5">
                <label className="text-[10px] font-semibold text-gray-400 uppercase tracking-widest">Store Name</label>
                <input
                  type="text"
                  name="storeName"
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-[10px] font-semibold text-gray-400 uppercase tracking-widest">Store Tagline</label>
                <input
                  type="text"
                  name="storeTagline"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="flex flex-col gap-1.5">
                  <label className="text-[10px] font-semibold text-gray-400 uppercase tracking-widest">Logo Image</label>
                  <input
                    type="file"
                    accept="image/*"
                    onChange={(e) => handleFileUpload(e, null, 'logoUrl')}
                    className="text-xs text-gray-500 file:mr-3 file:py-2 file:px-3 file:rounded-xl file:border-0 file:text-[10px] file:font-semibold file:uppercase file:tracking-wider file:bg-yellow-500/10 file:text-yellow-500 hover:file:bg-yellow-500/20"
                  />
                  {formData.logoUrl && (
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-[10px] font-semibold text-gray-400 uppercase tracking-widest">Favicon (.ico/.png)</label>
                  <input
                    type="file"
                    accept="image/*"
          ...
          {activeTab === 'colors' && (
            <div className="space-y-5">
              <h3 className="text-sm font-semibold text-white uppercase tracking-wider border-b border-white/5 pb-2">Theme Colors</h3>
              
              <div className="grid grid-cols-2 gap-4">
                {Object.keys(formData.colors).map(colorKey => (
                  <div key={colorKey} className="flex flex-col gap-1.5">
                    <label className="text-[10px] font-semibold text-gray-400 uppercase tracking-widest capitalize">{colorKey} Color</label>
          ...
          {activeTab === 'announcement' && (
            <div className="space-y-5">
              <h3 className="text-sm font-semibold text-white uppercase tracking-wider border-b border-white/5 pb-2">Announcement Bar</h3>
              
              <div className="flex items-center justify-between bg-slate-950/30 border border-white/5 p-4 rounded-2xl">
                <div>
                  <p className="text-[10px] font-semibold text-white uppercase tracking-widest">Enable Announcement Bar</p>
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-[10px] font-semibold text-gray-400 uppercase tracking-widest">Announcement Text</label>
                <textarea
                  name="text"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="flex flex-col gap-1.5">
                  <label className="text-[10px] font-semibold text-gray-400 uppercase tracking-widest">Background Color</label>
                  <div className="flex gap-2">
                    <input
                      type="color"
                      name="bgColor"
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-[10px] font-semibold text-gray-400 uppercase tracking-widest">Text Color</label>
                  <div className="flex gap-2">
                    <input
                      type="color"
                      name="textColor"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="flex flex-col gap-1.5">
                  <label className="text-[10px] font-semibold text-gray-400 uppercase tracking-widest">Scroll Speed (seconds)</label>
                  <input
                    type="number"
                    name="scrollSpeed"
                  ...
                  />
                  <span className="text-[8px] text-gray-500 font-semibold uppercase">Slower speed = higher duration</span>
                </div>

                <div className="flex items-center justify-between bg-slate-950/30 border border-white/5 p-3 rounded-2xl self-center mt-4">
                  <span className="text-[10px] font-semibold text-gray-400 uppercase tracking-widest">Infinite Loop</span>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      type="checkbox"
                      name="infinite"
          ...
          {activeTab === 'banners' && (
            <div className="space-y-5">
              <h3 className="text-sm font-semibold text-white uppercase tracking-wider border-b border-white/5 pb-2">Banner Settings</h3>
              
              <div className="flex flex-col gap-1.5">
                <label className="text-[10px] font-semibold text-gray-400 uppercase tracking-widest">Desktop Hero Banner</label>
                <input
                  type="file"
                  accept="image/*"
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-[10px] font-semibold text-gray-400 uppercase tracking-widest">Mobile Hero Banner</label>
                <input
                  type="file"
                  accept="image/*"
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-[10px] font-semibold text-gray-400 uppercase tracking-widest">General Offer Banner</label>
                <input
                  type="file"
                  accept="image/*"
          ...
          {activeTab === 'delivery' && (
            <div className="space-y-5">
              <h3 className="text-sm font-semibold text-white uppercase tracking-wider border-b border-white/5 pb-2">Delivery Settings</h3>
              
              <div className="flex flex-col gap-1.5">
                <label className="text-[10px] font-semibold text-gray-400 uppercase tracking-widest font-mono">Standard Delivery Charge (₹)</label>
                <input
                  type="number"
                  name="charge"
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-[10px] font-semibold text-gray-400 uppercase tracking-widest font-mono">Free Delivery For Orders Above (₹)</label>
                <input
                  type="number"
                  name="freeAbove"
          ...
          {activeTab === 'homepage' && (
            <div className="space-y-5">
              <h3 className="text-sm font-semibold text-white uppercase tracking-wider border-b border-white/5 pb-2">Homepage Sections</h3>
              ...
              <div className="space-y-3 bg-slate-950/20 p-4 border border-white/5 rounded-2xl">
                {Object.keys(formData.homepage).map(sectionKey => (
                  <div key={sectionKey} className="flex items-center justify-between">
                    <span className="text-[10px] font-semibold text-gray-400 uppercase tracking-widest">{sectionKey.replace('show', 'Show ')}</span>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                        type="checkbox"
                        name={sectionKey}
              ...
              <h3 className="text-sm font-semibold text-white uppercase tracking-wider border-b border-white/5 pb-2 pt-2">Product Card Badges & Actions</h3>
              
              <div className="space-y-3 bg-slate-950/20 p-4 border border-white/5 rounded-2xl">
                {Object.keys(formData.productCard).map(cardKey => (
                  <div key={cardKey} className="flex items-center justify-between">
                    <span className="text-[10px] font-semibold text-gray-400 uppercase tracking-widest">{cardKey.replace('show', 'Show ')}</span>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                        type="checkbox"
                        name={cardKey}
          ...
          {activeTab === 'contact' && (
            <div className="space-y-5">
              <h3 className="text-sm font-semibold text-white uppercase tracking-wider border-b border-white/5 pb-2">Support & Social Links</h3>
              
              <div className="grid grid-cols-2 gap-4">
                <div className="flex flex-col gap-1.5">
                  <label className="text-[10px] font-semibold text-gray-400 uppercase tracking-widest">Phone Support</label>
                  <input
                    type="text"
                    name="phone"
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-[10px] font-semibold text-gray-400 uppercase tracking-widest font-mono">WhatsApp Number</label>
                  <input
                    type="text"
                    name="whatsapp"
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-[10px] font-semibold text-gray-400 uppercase tracking-widest">Support Email</label>
                <input
                  type="email"
                  name="email"
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-[10px] font-semibold text-gray-400 uppercase tracking-widest">Store Address</label>
                <textarea
                  name="address"
              ...
              <div className="grid grid-cols-3 gap-3">
                <div className="flex flex-col gap-1.5">
                  <label className="text-[9px] font-semibold text-gray-400 uppercase tracking-widest">Instagram</label>
                  <input
                    type="text"
                    name="instagram"
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-[9px] font-semibold text-gray-400 uppercase tracking-widest">Facebook</label>
                  <input
                    type="text"
                    name="facebook"
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-[9px] font-semibold text-gray-400 uppercase tracking-widest">YouTube</label>
                  <input
                    type="text"
                    name="youtube"
              ...
              <h3 className="text-sm font-semibold text-white uppercase tracking-wider border-b border-white/5 pb-2 pt-2">Footer Details</h3>

              <div className="flex flex-col gap-1.5">
                <label className="text-[10px] font-semibold text-gray-400 uppercase tracking-widest">Footer Tagline/Text</label>
                <input
                  type="text"
                  name="text"
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-[10px] font-semibold text-gray-400 uppercase tracking-widest">Footer Copyright Text</label>
                <input
                  type="text"
                  name="copyright"
          ...
          {activeTab === 'seo' && (
            <div className="space-y-5">
              <h3 className="text-sm font-semibold text-white uppercase tracking-wider border-b border-white/5 pb-2">SEO & Search Settings</h3>
              
              <div className="flex flex-col gap-1.5">
                <label className="text-[10px] font-semibold text-gray-400 uppercase tracking-widest">Website Tab Title</label>
                <input
                  type="text"
                  name="title"
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-[10px] font-semibold text-gray-400 uppercase tracking-widest">Meta Description</label>
                <textarea
                  name="description"
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-[10px] font-semibold text-gray-400 uppercase tracking-widest">Keywords (comma separated)</label>
                <input
                  type="text"
                  name="keywords"
          ...
          <div className="flex justify-end gap-3 pt-4 border-t border-yellow-900/10">
            <button
              type="submit"
              disabled={saving}
              className="flex items-center justify-center gap-2 bg-yellow-500 hover:bg-yellow-600 text-slate-950 px-8 py-3.5 rounded-xl text-xs font-semibold uppercase tracking-widest transition-all disabled:opacity-50 w-full sm:w-auto"
            >
              {saving ? (
        ...
        <div className="lg:col-span-4 bg-gray-900/50 backdrop-blur-xl p-6 rounded-3xl border border-yellow-900/10 space-y-6 lg:sticky lg:top-6">
          ...
          >
            {/* Header Tag */}
            <div className="text-[7px] font-semibold tracking-widest uppercase border-b pb-1 opacity-60" style={{ borderColor: formData.colors.border }}>
              Store Mockup
            </div>
            ...
            {formData.announcement.enabled && (
              <div 
                className="p-1 rounded text-center text-[8px] font-semibold uppercase overflow-hidden whitespace-nowrap transition-all"
                style={{ 
            ...
            <div className="flex items-center justify-between pb-2 border-b border-white/5">
              <div className="flex items-center gap-2">
                {formData.logoUrl ? (
                  ...
                  <div className="w-6 h-6 rounded bg-yellow-500 flex items-center justify-center text-black font-semibold text-[9px]">S</div>
                )}
                <span className="text-[10px] font-semibold tracking-wider uppercase">
                  {formData.storeName || "Store Name"}
                </span>
              </div>
              <span className="text-[7px] font-semibold uppercase opacity-60">Menu</span>
            </div>
            ...
            >
              ...
              <div className="relative aspect-square w-full bg-slate-950/40 rounded-lg flex items-center justify-center overflow-hidden">
                <span className="text-[9px] font-semibold opacity-30 uppercase tracking-widest">Image</span>
                ...
                {formData.productCard.showStockBadge && (
                  <div className="absolute top-1.5 left-1.5 bg-yellow-500 text-black text-[5px] font-semibold uppercase px-1 rounded">
                    🏆 BEST SELLER
                  </div>
                )}
                ...
                {formData.productCard.showQuickView && (
                  <div className="absolute bottom-1.5 inset-x-1.5 bg-black/70 py-1 text-center rounded text-[5px] font-semibold uppercase tracking-wider text-yellow-500">
                    Quick View
                  </div>
                )}
              </div>
              ...
              <div className="space-y-1">
                <span className="text-[7px] font-semibold uppercase tracking-widest text-yellow-500/70">Category</span>
                <p className="text-[10px] font-semibold uppercase tracking-wider truncate">Sample Product Name</p>
                ...
                <div className="flex items-center gap-1.5 pt-1">
                  <span className="text-[11px] font-semibold" style={{ color: formData.colors.accent }}>₹399</span>
                  <span className="text-[8px] line-through text-gray-500">₹499</span>
                  
                  {/* Discount Badge */}
                  {formData.productCard.showDiscountBadge && (
                    <span className="text-[8px] font-semibold text-green-500">20% off</span>
                  )}
                </div>
              </div>
            </div>
            ...
            <button 
              type="button"
              className="w-full py-2.5 rounded-xl text-[8px] font-semibold uppercase tracking-wider transition-all"
              style={{ 
          ...
          <div className="bg-yellow-950/20 border border-yellow-900/30 rounded-2xl p-4 flex gap-3 text-yellow-600 text-[10px] leading-relaxed">
            ...
            <div>
              <span className="font-semibold block uppercase tracking-wider text-[9px] mb-1">Theme Overrides Notice</span>
